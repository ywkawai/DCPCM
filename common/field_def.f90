...
integer, parameter :: GNYA = AGCM_NY
integer, parameter :: GNZA = AGCM_NZ

character(TOKEN),  parameter :: OCN = OGCM_COMP_NAME
integer, parameter :: GNXO =  OGCM_NX
integer, parameter :: GNYO =  OGCM_NY
integer, parameter :: GNZO =  OGCM_NZ
